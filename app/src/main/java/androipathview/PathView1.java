...
public class PathView1 extends View {
    ...
    private void getFromAttributes(Context context, AttributeSet attrs) {
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PathView1);
        try {
            if (a != null) {
                paint.setColor(a.getColor(R.styleable.PathView1_pathColor1, 0xff00ff00));
                paint.setStrokeWidth(a.getFloat(R.styleable.PathView1_pathWidth1, 8.0f));
                svgResourceId = a.getResourceId(R.styleable.PathView1_svg1, 0);
            }
        } finally {
            if (a != null) {
                a.recycle();
    ...
    public static class AnimatorBuilder {
         ...
         */
        public AnimatorBuilder(final PathView1 pathView) {
